      ...
      <div className="flex flex-col items-center justify-center min-h-screen px-4">
        <div className="bg-white/5 shadow-lg rounded-lg p-6 md:p-8 max-w-md w-full text-center">
          ...
          <p className="text-gray-600 mb-6">
            Your account is currently inactive. While deactivated, your profile
            is hidden, and you cannot access the platform's features or interact
