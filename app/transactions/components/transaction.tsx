...
export const Transaction: React.FC<TransactionProps> = ({ transaction }) => {
  const transaction_type =
    transaction?.transaction_type.split("_").join(" ") || "";
  ...
  return (
    <div className="w-[400px] p-4 bg-white shadow-md rounded-lg border border-gray-300">
      <div className="mt-4">
        ...
        <div className="flex justify-between mt-2">
          ...
          <span className="text-gray-500 capitalize">
            {transaction_type === "Payout" ? "Disbursement" : transaction_type}
          </span>
        </div>
        <div className="flex justify-between mt-2">
      ...
      <div className="mt-4 border-t border-gray-300 pt-4">
        ...
        {transaction.transaction_type === "downpayment" ||
        transaction.transaction_type === "final_payment" ||
        transaction.transaction_type === "refund" ? (
          <div className="flex justify-between mt-2">
            <span className="font-medium text-gray-600">Name:</span>
            <span className="text-gray-500">
              {transaction.booking.client.fullname}
            </span>
          </div>
          ...
          <div className="flex justify-between mt-2">
            <span className="font-medium text-gray-600">Name:</span>
            <span className="text-gray-500">
              {transaction.booking.artist.user.fullname}
            </span>
          </div>
        ) : null}
