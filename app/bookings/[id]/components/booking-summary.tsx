...
export const BookingSummary: React.FC<BookingSummaryProps> = ({ booking }) => {
  return (
    <div className="p-4 bg-white rounded-lg text-black capitalize">
      ...
      <div className="px-2">
        ...
        <div className="flex justify-between">
          <h2>
            Package Amount: <span>{booking.rate.amount}</span>
          </h2>
        </div>
        <h2>
          Downpayment Paid:{" "}
          <span>{booking.downpayment_amount - booking.service_fee}</span>
        </h2>
        <div className="flex justify-between">
          <h2>Total </h2>
